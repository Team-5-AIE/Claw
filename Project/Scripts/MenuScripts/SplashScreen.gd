...
func _ready():
	...
	fade_tween.tween_property($"../Control/CanvasLayer/Label","modulate", Color.TRANSPARENT, 1).set_delay(0.4).set_ease(Tween.EASE_IN)
	fade_tween.tween_property($"../Control/CanvasLayer/Label","modulate", Color(1,1,1,0.5), 1).set_delay(0.4).set_ease(Tween.EASE_OUT)
